        ...
        <ul class="nav nav-tabs border-0 flex-column flex-lg-row">
          ...
          <li class="nav-item">
            ...
            <div class="dropdown-menu dropdown-menu-arrow">
              ...
              <?php if(get_role("admin")){?>
              <div class="dropdown-divider"></div>
              <a href="https://wa.link/jhhnpg" class="dropdown-item"><?=lang("Modules")?></a>
              <a href="https://downloaddigital.store/" class="dropdown-item"><?=lang("Documentation")?></a>
              <?php } ?>
              
              <?php if(get_role("admin")){?>          
              <a href="https://wa.me/+919835518468" class="dropdown-item"><?=lang("Message_on_WhatsApp")?></a>
              <?php } ?>
            </div>
          </li>
          <?php } ?>
          ...
          ?>
          <li class="nav-item">
            <a href="https://wa.link/jhhnpg" class="nav-link <?=(segment(1) == 'Add_more_features_in_script')?"active":""?>"><i class="fa fa-table"></i> <?=lang("Add_more_features_in_script")?></a>
          </li>
